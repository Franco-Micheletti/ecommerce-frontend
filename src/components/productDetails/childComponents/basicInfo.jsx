        ...
        <div className="right-panel-basic">
            {
                favoritesIconChange.includes(productData["basic"]["id"]) === true
                    ?   <div style={{top: "-34px",left: "301px",background:"none"}} onClick={() => removeProductFromUserFavorites(productData["basic"]["id"],userId)} className="to-favorite-icon-home-added">
                    ...
                    :    <div  style={{top: "-34px",left: "301px",background:"none"}} onClick={() => addProductToUserFavorites(productData["basic"]["id"],userId)} className="to-favorite-icon-home">
